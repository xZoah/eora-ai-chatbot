...
"""
        ...
        if complexity_level == "simple":
            return base_prompt + """
ПРАВИЛА ДЛЯ ПРОСТОГО УРОВНЯ:
- Отвечай кратко и по существу
- НЕ используй ссылки на источники
- НЕ добавляй "Источники:" в конце
- Фокусируйся на конкретных примерах проектов
- Используй простой язык без технических деталей"""
        
        elif complexity_level == "medium":
            return base_prompt + """
ПРАВИЛА ДЛЯ СРЕДНЕГО УРОВНЯ:
- Отвечай подробно с конкретными примерами
- В КОНЦЕ ответа добавь раздел "Источники:" со списком проектов
- НЕ вставляй ссылки в текст ответа
- Упоминай технологии и результаты проектов
- Используй профессиональный тон"""
        
        elif complexity_level == "hard":
            return base_prompt + """
ПРАВИЛА ДЛЯ СЛОЖНОГО УРОВНЯ:
- Отвечай очень подробно с техническими деталями
- ОБЯЗАТЕЛЬНО вставляй ссылки прямо в текст ответа в формате [название проекта](url)
- Каждый упомянутый проект должен содержать ссылку
- Используй Markdown форматирование: **жирный**, *курсив*
- Включай конкретные технологии, результаты, метрики
